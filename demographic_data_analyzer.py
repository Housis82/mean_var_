...
def calculate_demographic_data(print_data=True):
    ...
    advanced_ed = df['education'].isin(['Bachelors', 'Masters', 'Doctorate'])

    higher_education_rich = round(
        (df[advanced_ed]['salary'] == '>50K').sum() / advanced_ed.sum() * 100, 1
    )
    ...
    country_pct    = (country_rich / country_total * 100).dropna()
